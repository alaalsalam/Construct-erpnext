...
## تحديث اتفاقيات المقاولين

| البند | الحالة | الملاحظة |
|---|---|---|
| استخدام هيكل قائم بدلاً من تكرار DocTypes | Passed | تم توسيع Subcontract كـ Contractor Agreement |
| بنود الاتفاقية مرتبطة ببنود العمل | Passed | 38 Work Items مرتبطة بـ PROJ-0002 |
| القياسات مرتبطة بالاتفاقية | Passed | 16 Measurement Entries تحمل اتفاقية مقاول |
| المستخلصات مرتبطة بالاتفاقية | Passed | IPC Lines تحمل الاتفاقية، و3 IPCs تحمل اتفاقية على مستوى الرأس حيث كان النطاق موحداً |
| تقارير الاتفاقيات | Passed | 4 تقارير جديدة تعمل وتعرض بيانات PROJ-0002 |
| المستندات المحاسبية | Passed | لم يتم إنشاء Payment Entry أو Journal Entry أو Sales Invoice submitted أو GL backfill |

القرار: طبقة اتفاقيات المقاولين جاهزة للعرض ضمن قصة PROJ-0002.

## تحديث QA - فرع التكامل قبل CMD-27

| البند | الحالة | الملاحظة |
|---|---|---|
| دمج إصلاحات التقارير | Passed | تم الحفاظ على فرع إصلاح ظهور الجداول والداشبورد |
| دمج اتفاقيات المقاولين | Passed | تم الحفاظ على طبقة Subcontract كاتفاقية مقاول |
| مصدر CMD-27 | Passed | الفرع المعتمد هو `feature/phase-1-integrated-presentation-ready` |
