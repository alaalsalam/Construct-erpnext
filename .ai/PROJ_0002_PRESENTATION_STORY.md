...
## 14. تحديث اتفاقيات المقاولين

أصبح لدى `PROJ-0002` طبقة واضحة لاتفاقيات المقاولين تربط نطاق التعاقد ببنود BOQ وبنود العمل والقياسات والمستخلصات.

السجلات التي تفتح أثناء العرض:
...
1. افتح `BOQ-PROJ-0002-001` لعرض البنود والكميات المخططة.
2. افتح Work Items المرتبطة، ثم أظهر حقل Contractor Agreement.
3. افتح اتفاقية المقاول لشرح الكمية والسعر والمبلغ المتفق عليه.
4. افتح Contractor Agreement Item Progress لعرض المقاس، المعتمد، والمتبقي.
5. افتح Contractor Agreement to IPC Traceability لشرح كيف انتقلت القياسات إلى IPC.
6. افتح Contractor Account Statement وRetention Register Report لشرح الأثر على كشف المقاول والمحتجزات.

الرسالة للعميل: الاتفاقية ليست جدولاً منفصلاً، بل طبقة تعاقدية تربط ما تم الاتفاق عليه بما تم قياسه واعتماده وما تبقى على المقاول.

## 15. تحديث فرع التكامل قبل CMD-27

- الفرع الموحد `feature/phase-1-integrated-presentation-ready` يجمع إصلاحات التقارير والداشبورد مع اتفاقيات المقاولين.
- استخدم التقارير المفلترة على `PROJ-0002` للتحليل التفصيلي، واتفاقيات المقاولين لإثبات ربط نطاق التعاقد بالقياسات والمستخلصات.
- هذا الفرع هو نقطة الانطلاق الصحيحة لاستكمال فواتير البيع والتحصيل في CMD-27.
