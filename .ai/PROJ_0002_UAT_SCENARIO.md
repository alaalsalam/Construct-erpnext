...
**الهدف:** إظهار قدرة النظام على إدارة الإيجارات من الحجز إلى عقد إيجار نشط وجدول إيجار.

**التوضيح للعميل:**
> "في PROJ-0002 يوجد الآن عقد إيجار تشغيلي جاهز للـ UAT يوضح انتقال الوحدة إلى Rented وتوليد 12 قسط إيجار شهري."

**المسار:**
```
Sales & Rental Workspace > Lease Contract
→ LC-2026-00003
```

```
Reports & Analytics > Rent Schedule Report
→ lease_contract = LC-2026-00003
```

**ما يجب إظهاره:**
- Unit: `BLD-PROJ-000-001-S-G-02`
- Reservation: `RES-2026-00006` حالته Converted
- Tenant / Customer: `مستأجر تجاري محتمل`
- Lease status: Active
- Monthly Rent: `79,000`
- Rent Schedule: 12 صفاً بإجمالي `948,000`

**ما يُثبته للعميل:**
- النظام جاهز لعقود الإيجار
- Rent Schedule يُولد تلقائياً
- المستأجر مخزن على العقد (وليس على الوحدة)
- Rent Invoice وRent Payment Entry يمكن اختبارهما لاحقاً إذا طلب العميل ذلك
...
4. **أوقف عند حدود النطاق:** إذا سأل العميل عن البيع، وضّح أن `ACC-SINV-2026-00002` و`ACC-PAY-2026-00010` موجودان كتحقق جزئي. وإذا سأل عن الإيجار، وضّح أن عقد الإيجار والجدول جاهزان، أما فاتورة الإيجار وسند قبض الإيجار فيمكن اختبارهما لاحقاً.
