...
def setup_company(company):
    """Legacy helper for El Salvador setup.

    El Salvador localization disabled for generic product build.
    This function is intentionally not called by after_install.
    """
...
def create_custom_fields():
    """Create legacy custom fields on stock DocTypes for El Salvador.
    ...
    custom_fields = {
        "Supplier": [
            ...
            },
            {
                ...
                "module": "GCS Admin",
                "description": "Numero de Identificacion Tributaria (0000-000000-000-0)",
            },
            {
                "fieldname": "sv_nrc",
                "label": "NRC",
                ...
                "insert_after": "sv_nit",
                "module": "GCS Admin",
                "description": "Numero de Registro de Contribuyente",
            },
        ],
        "Customer": [
            {
        ...
        "Employee": [
            ...
            },
            {
                ...
                "insert_after": "sv_section_break",
                "module": "GCS Admin",
                "description": "Documento Unico de Identidad (00000000-0)",
            },
            {
                "fieldname": "sv_nit",
                "label": "NIT",
